...
$(function(){
  ...
  var correctCount = 0;
  var q = [
      {'Q':'¿Cómo se llama el programa que utilizamos para leer y escribir documentos?', 'A':3,'C':['Power point','Excel','Word']},
      {'Q':'¿Cómo se llama el programa que utilizamos para realizar tablas con base en números?', 'A':2,'C':['Power point','Excel','Word']},
      {'Q':'¿Cómo se llama el programa que utilizamos para hacer presentaciones?', 'A':1,'C':['Power point','Excel','Word']},
      {'Q':'Es un ejemplo de una plantilla de Word que vimos en este módulo', 'A':1,'C':['Curriculo Vitae','Tabla con gastos personales','Linea de tiempo']},
      {'Q':'En los gráficos de excel, que tipo de gráfico no vimos en el módulo ', 'A':3,'C':['Pastel o Pie','Barras','Caja y bigotes']},
